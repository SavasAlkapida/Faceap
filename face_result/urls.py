...
from .views import create_advertisement, advertisement_list, update_advertisements, advertisement_list, save_advertisements, advertisement_list, upload_file, delete_all_items, show_highest_impressions, list_products, handle_uploaded_file, fetch_xml_data, high_score_products, trigger_record_daily_score_view, trigger_fetch_xml_data, trigger_tasks, display_highest_score_increase, product_get, product_get, product_detail,hidden_products
